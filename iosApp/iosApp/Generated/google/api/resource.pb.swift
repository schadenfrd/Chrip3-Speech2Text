...
///       pattern: "organizations/{organization}/logs/{log}"
///       pattern: "billingAccounts/{billing_account}/logs/{log}"
nonisolated struct Google_Api_ResourceDescriptor: Sendable {
  ...
  /// resource pattern.
  nonisolated enum History: SwiftProtobuf.Enum, Swift.CaseIterable {
...
/// an API resource.
nonisolated struct Google_Api_ResourceReference: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated let Google_Api_Resource_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
/// An annotation that describes a resource reference, see
/// [ResourceReference][].
nonisolated let Google_Api_Extensions_resource_reference = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Google_Api_ResourceReference>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
...
/// An annotation that describes a resource definition without a corresponding
/// message; see [ResourceDescriptor][].
nonisolated let Google_Api_Extensions_resource_definition = SwiftProtobuf.MessageExtension<SwiftProtobuf.RepeatedMessageExtensionField<Google_Api_ResourceDescriptor>, SwiftProtobuf.Google_Protobuf_FileOptions>(
...
/// An annotation that describes a resource definition, see
/// [ResourceDescriptor][].
nonisolated let Google_Api_Extensions_resource = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Google_Api_ResourceDescriptor>, SwiftProtobuf.Google_Protobuf_MessageOptions>(
  _protobuf_fieldNumber: 1053,
