...
/// network API call.
nonisolated struct Google_Longrunning_Operation: Sendable {
...
nonisolated struct Google_Longrunning_GetOperationRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Google_Longrunning_ListOperationsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// [Operations.ListOperations][google.longrunning.Operations.ListOperations].
nonisolated struct Google_Longrunning_ListOperationsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Google_Longrunning_CancelOperationRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Google_Longrunning_DeleteOperationRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated struct Google_Longrunning_WaitOperationRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///       };
///     }
nonisolated struct Google_Longrunning_OperationInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated let Google_Longrunning_Operations_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
/// Required for methods that return `google.longrunning.Operation`; invalid
/// otherwise.
nonisolated let Google_Longrunning_Extensions_operation_info = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Google_Longrunning_OperationInfo>, SwiftProtobuf.Google_Protobuf_MethodOptions>(
