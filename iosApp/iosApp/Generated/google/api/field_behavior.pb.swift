...
nonisolated enum Google_Api_FieldBehavior: SwiftProtobuf.Enum, Swift.CaseIterable {
...
nonisolated let Google_Api_FieldBehavior_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
///     [(google.api.field_behavior) = OUTPUT_ONLY,
///      (google.api.field_behavior) = IMMUTABLE];
nonisolated let Google_Api_Extensions_field_behavior = SwiftProtobuf.MessageExtension<SwiftProtobuf.RepeatedEnumExtensionField<Google_Api_FieldBehavior>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
