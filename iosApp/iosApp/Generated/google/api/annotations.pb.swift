...
nonisolated let Google_Api_Annotations_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
/// See `HttpRule`.
nonisolated let Google_Api_Extensions_http = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Google_Api_HttpRule>, SwiftProtobuf.Google_Protobuf_MethodOptions>(
